...
echo "<h1>EX1</h1>";
function displayInformation($name = "Trần Đặng văn Nguyên",$project="New Website") {
    echo "My name is $name and your project is $project";
}
displayInformation("Võ Hữu Quang Tâm","Producer");
echo '<br>';
displayInformation("QTV","Proplayer");
?>